...
Module's have metadata with a [`supported_by`](http://docs.ansible.com/ansible/dev_guide/developing_modules_documenting.html#ansible-metadata-block).
...
**<a name="label-needs_maintainer">needs_maintainer</a>** | pull requests | no | Ansibullbot is unable to identify authors or maintainers of the related module. Check `author` field format in [`DOCUMENTATION block`](http://docs.ansible.com/ansible/dev_guide/developing_modules_documenting.html#documentation-block) and module entry in [Bot Meta](http://docs.ansible.com/ansible/latest/dev_guide/developing_modules_in_groups#finally).
